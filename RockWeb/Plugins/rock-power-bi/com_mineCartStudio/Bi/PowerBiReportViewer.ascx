<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PowerBiReportViewer.ascx.cs" Inherits="RockWeb.Plugins.com_mineCartStudio.Bi.PowerBiReportViewer" %>
            ...
            <div class="js-report-conatiner">
                <div class="report-wrapper js-report-wrapper">
                    <div style="position: relative; width: 100%; height: 100%;">
                        <a href="#" class="btn btn-action report-fullsize" style="position: absolute; top: 0; left: 0; border-radius: 0;"><i class="fa fa-arrows-alt"></i></a>
