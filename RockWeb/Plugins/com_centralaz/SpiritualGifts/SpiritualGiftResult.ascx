<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SpiritualGiftResult.ascx.cs" Inherits="com.centralaz.SpiritualGifts.SpiritualGiftResult" ViewStateMode="Enabled" EnableViewState="true" %>
