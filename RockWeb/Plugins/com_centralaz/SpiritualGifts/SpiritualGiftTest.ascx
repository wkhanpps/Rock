<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SpiritualGiftTest.ascx.cs" Inherits="com.centralaz.SpiritualGifts.SpiritualGiftTest" ViewStateMode="Enabled" EnableViewState="true" %>
